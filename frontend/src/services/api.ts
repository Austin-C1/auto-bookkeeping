...
export const apiService = {
  ...
  bookkeeping: {
    dashboard: (data: { businessDate?: string; workspaceType?: string } = {}) => apiClient.post<ApiResponse<unknown>>('/bookkeeping/dashboard', data),
    listCrownAccounts: () => apiClient.post<ApiResponse<unknown>>('/bookkeeping/crown/accounts/list', {}),
    saveCrownAccount: (data: unknown) => apiClient.post<ApiResponse<unknown>>('/bookkeeping/crown/accounts/save', data),
    ...
    listWhatsappGroups: () => apiClient.post<ApiResponse<unknown>>('/bookkeeping/whatsapp/groups/list', {}),
    saveWhatsappGroup: (data: unknown) => apiClient.post<ApiResponse<unknown>>('/bookkeeping/whatsapp/groups/save', data),
    whatsappBootstrap: () => apiClient.post<ApiResponse<unknown>>('/bookkeeping/whatsapp/bootstrap', {}),
    whatsappStatus: () => apiClient.post<ApiResponse<unknown>>('/bookkeeping/whatsapp/status', {}),
    syncWhatsappChats: () => apiClient.post<ApiResponse<unknown>>('/bookkeeping/whatsapp/chats/sync', {}),
