...
const Login: React.FC = () => {
  ...
  const redirectPath = (() => {
    ...
    return from?.startsWith('/bookkeeping') ? from : '/bookkeeping'
  })()
  ...
  return (
    <div style={{
      ...
      <Card style={{ width: isMobile ? '100%' : 380, textAlign: 'center' }}>
        <CalculatorOutlined style={{ fontSize: 36, color: '#1677ff', marginBottom: 16 }} />
        <Title level={2} style={{ marginBottom: 8 }}>自动做账</Title>
