...
function Write-Status {
    ...
    Write-Host "[AutoBookkeeping] $Message"
}
...
function Fail-Launch {
    ...
    Write-Host ''
    Write-Host "[AutoBookkeeping] Launch failed: $Message" -ForegroundColor Red
    Write-Host "[AutoBookkeeping] Logs: $rootDir"
    Write-Host ''
...
function Get-CurrentBackendJar {
    ...
    return Get-ChildItem -Path $backendLibDir -Filter 'auto-bookkeeping-backend-*.jar' -File -ErrorAction SilentlyContinue |
