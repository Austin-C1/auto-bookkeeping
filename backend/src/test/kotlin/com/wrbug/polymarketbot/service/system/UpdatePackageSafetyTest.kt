...
class UpdatePackageSafetyTest {
    ...
    fun `program files are allowed to be updated`() {
        ...
        assertTrue(UpdatePackageSafety.isAllowedProgramPath("start-whatsapp-bridge.ps1"))
        ...
        assertTrue(UpdatePackageSafety.isAllowedProgramPath("whatsapp-bridge/package.json"))
        assertTrue(UpdatePackageSafety.isAllowedProgramPath("whatsapp-bridge/package-lock.json"))
        assertTrue(UpdatePackageSafety.isAllowedProgramPath("whatsapp-bridge/server.mjs"))
    ...
    fun `apply script uses encoded paths and real file list newlines`() {
        ...
        assertTrue(script.contains("*start-whatsapp-bridge.ps1*"))
        assertTrue(script.contains("*whatsapp-bridge*server.mjs*"))
